...
<!-- Telegram Button -->
<a href="https://t.me/+ZSDxZHM19EBkOTg1" target="_blank" style="position:fixed;bottom:88px;right:24px;z-index:2000;width:54px;height:54px;border-radius:50%;background:#229ED9;border:none;cursor:pointer;box-shadow:0 4px 16px rgba(0,0,0,0.25);display:flex;align-items:center;justify-content:center;text-decoration:none;">
